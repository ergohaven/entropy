...
[![Latest release](https://img.shields.io/badge/latest-v0.3.0-lightgrey.svg)](https://github.com/ergohaven/entropy/releases)
...
- `entropy-v0.3.0-x86_64.AppImage`
- `entropy-v0.3.0-windows-x86_64.exe`
- `entropy-v0.3.0-macos-arm64.dmg`
- `entropy-v0.3.0-macos-x86_64.dmg`

Stable tags such as `v0.3.0` publish a regular GitHub release and mark it as
latest. Tags with a suffix, such as `v0.3.0-rc.1`, publish the same artifacts as
a GitHub prerelease.
