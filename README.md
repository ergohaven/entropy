...
- `ergohaven-entropy_0.3.9_amd64.deb`
- `ergohaven-entropy-0.3.9-1.x86_64.rpm`
- `ergohaven-entropy-0.3.9-1-x86_64.pkg.tar.zst`
- `entropy-v0.3.9-x86_64.AppImage`
- `entropy-v0.3.9-x64.msi`
- `entropy-v0.3.9-windows-x86_64.exe`
- `entropy-v0.3.9-macos-universal.dmg`
